        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PacjentID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Imie = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Nazwisko = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imie = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Nazwisko = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Specjalizacja = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Adres = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Telefon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OddzialID = table.Column<int>(type: "int", nullable: false)
                },
