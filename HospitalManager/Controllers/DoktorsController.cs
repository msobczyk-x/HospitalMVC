...
namespace HospitalManager.Controllers
{
    public class DoktorsController : Controller
    {
        ...
        {
            ViewData["OddzialID"] = new SelectList(_context.Oddzial, "OddzialID", "OddzialID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DoktorID,Imie,Nazwisko,Specjalizacja,Adres,Telefon,OddzialID")] Doktor doktor)
        {
            ...
            ViewData["OddzialID"] = new SelectList(_context.Oddzial, "OddzialID", "OddzialID", doktor.OddzialID);
            return View(doktor);
        }
